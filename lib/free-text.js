...
/**
 * The open-ended member fields — qualification, occupation, and the links
 * column that import also accepts as "notes" or "remarks".
 *
...
const LIMITS = { qualification: 60, occupation: 60, links: 120 };
const LABELS = { qualification: 'Qualification', occupation: 'Occupation', links: 'Links' };
